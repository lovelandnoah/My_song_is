  ...
  noSongsAdded(){
    if(this.state.songs.length == 0){
      return(<p id="no-songs-notification"> It looks like this user doesn't have any songs added. </p>)
    }else{
      return(<button className="listen-to-song-button" onClick={this.playMode}>Play</button>)
    }
  }
