    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          'What to do when your account is visited:',
          React.createElement(
            'form',
            { action: '' },
            React.createElement(
              'input',
              { id: 'random', type: 'radio', name: 'play-type', value: 'random', defaultChecked: 'checked' },
              'Play Random'
            ),
            React.createElement(
              'input',
              { id: 'first', type: 'radio', name: 'play-type', value: 'first' },
              'Play First'
            )
          ),
          React.createElement(
